...
plt.savefig('/home/vljchr004/msc-hpc/round2/feedforward/round2_model1_history1.png', bbox_inches='tight')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('/home/vljchr004/msc-hpc/round2/feedforward/round2_model1_history2.png', bbox_inches='tight')

model1_dropout_0_5.probs = model1_dropout_0_5.predict_proba(x_test)

import numpy as np
np.savetxt("/home/vljchr004/msc-hpc/round2/feedforward/round2_model1_results.csv", np.array(model1_dropout_0_5.probs), fmt="%s")

np.savetxt("/home/vljchr004/msc-hpc/round2/feedforward/round2_model1_y_test.csv", np.array(y_test), fmt="%s")

model1_dropout_0_5.save('/home/vljchr004/msc-hpc/round2/feedforward/round2_model1_.h5')  # creates a HDF5 file 'my_model.h5'
