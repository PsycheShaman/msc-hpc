...
#    run = '000265309'
    ...
    with open('C:/Users/gerhard/Documents/msc-thesis-data/1_8 to 2_2 GeV/P_' + run + '.pkl', 'wb') as P_file:
      pickle.dump(P, P_file)
    
    with open('C:/Users/gerhard/Documents/msc-thesis-data/1_8 to 2_2 GeV/x_' + run + '.pkl', 'wb') as x_file:
      pickle.dump(x, x_file)
      
    with open('C:/Users/gerhard/Documents/msc-thesis-data/1_8 to 2_2 GeV/y_' + run + '.pkl', 'wb') as y_file:
